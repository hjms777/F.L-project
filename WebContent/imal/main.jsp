...
<%@page import="com.login.CustomInfo"%>
...
<body>
 ...
 <!-- 검색창 -->
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <a href="javascript:void(0)">
            ...
            <div class="main-text">
              <img src="<%=cp%>/imal/data/image_main/chanel-white_logo.png" alt="샤넬" />
              <span class="main-tit"></span><br/>
               <a href="https://www.chanel.com/kr/?utm_source=naver&utm_medium=brandsearch&utm_
                 campaign=wfj_fj_cococrush_2023_wave1&utm_content=worn_jkleb_pc_videotab_homelink&utm_
                 term=banner_static_%EC%83%A4%EB%84%AC"><button class="primary" >shop now</button></a>
            </div>
          </a>
        </div>
        <div class="swiper-slide">
          <a href="javascript:void(0)">
            ...
            <span class="line"></span>
            <div class="main-text">
              <img src="<%=cp%>/imal/data/image_main/celine-white_logo.png" alt="셀린느" />
              <span class="main-tit"></span><br/>
              <a href="https://www.celine.com/ko-kr/home?utm_source=naver&utm_medium=ppc&utm_
              campaign=Celine_FLG_KOR_APAC_Search-Naver_ADF_KRW_LVMH&utm_content=pc_homelink&utm_
              term=%EC%85%80%EB%A6%B0%EB%8A%90">
              <button class="primary" >shop now</button></a>
            </div>
          </a>
        </div>
        <div class="swiper-slide">
          <a href="javascript:void(0)">
            <img src="<%=cp%>/imal/data/image_main/celine_2.jpg" alt="디올" />
            <span class="line"></span>
            <div class="main-text">
              <img src="<%=cp%>/imal/data/image_main/dior-white_logo.png" alt="디올" />
              <span class="main-tit"></span><br/>
              <a href="https://www.dior.com/ko_kr?utm_source=Brandsearch_ko&utm_medium=CPC&utm_campaign=CDC_BS&utm_content=title_mainpage&utm_term=%EB%94%94%EC%98%AC">
              <button class="primary" >shop now</button></a>
            </div>
          </a>
        </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="product-pic">
              ...
              <span class="best-icon">new</span>
              <div class="pic-hover">
             	 <a href="<%=cp%>/itmall/article.do?goods_num=215"></a>
              </div>
            </div>
            <div class="product-info">
          ...
          <div class="swiper-slide">
            <div class="product-pic">
              ...
              <div class="pic-hover">
              	<a href="<%=cp%>/itmall/article.do?goods_num=216"></a>
              </div>
            </div>
            <div class="product-info">
          ...
          <div class="swiper-slide">
            <div class="product-pic">
              <a class="obj" href="javascript:void(0)">
                <img src="<%=cp%>/imal/data/image_main/andyou-c-1_2.jpg" alt="TRAFALGAR Volume sleeve wool coat (Camel)" />
              </a>
              <div class="pic-hover">
              	<a href="<%=cp%>/itmall/article.do?goods_num=217"></a>
              </div>
            </div>
            <div class="product-info">
          ...
          <div class="swiper-slide">
            <div class="product-pic">
              ...
              <div class="pic-hover">
              	<a href="<%=cp%>/itmall/article.do?goods_num=218"></a>
              </div>
            </div>
            <div class="product-info">
          ...
          <div class="swiper-slide">
            <div class="more-btn">
              <a href="<%=cp%>/itmall/goodslist3.do?cate=jacket&cate1=top&cate2=bottom">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="product-pic">
              ...
              <div class="pic-hover">
                <a href="<%=cp%>/itmall/article.do?goods_num=219"></a>
              </div>
            </div>
            <div class="product-info">
              <span class="brand-icon">DIOR</span>
          ...
          <div class="swiper-slide">
            <div class="product-pic">
              ...
              <div class="pic-hover">
                <a href="<%=cp%>/itmall/article.do?goods_num=220"></a>
              </div>
            </div>
            <div class="product-info">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="product-pic">
              ...
              <div class="pic-hover">
                <a href="<%=cp%>/itmall/article.do?goods_num=221"></a>
              </div>
            </div>
            <div class="product-info">
          ...
          <div class="swiper-slide">
            <div class="more-btn">
              <a href="<%=cp%>/itmall/goodslist4.do?cate=watch&cate1=cap&cate2=socks&cate3=wallet&cate4=belt">
                <img src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-plus-empty-128.png" alt="더보기" />
              </a>
              <span class="sub-tit">더보기</span>
            </div>
      ...
      <div class="magazine-sub">
        <div class="swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <a href="javascript:void(0)">
                <img src="<%=cp%>/imal/data/image_main/solid_1.jpg" alt="핫 메시 라운지 체어_내추럴 옐로우" />
              </a>
            </div>
            <div class="swiper-slide">
              <a href="javascript:void(0)">
                <img src="<%=cp%>/imal/data/image_main/solid_4.jpg" alt="피콜리나 비치 체어_아주르블루(AK)" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide show-con">
            <ul class="show-in">
              ...
              <li class="show-desc">
                <h5>WOOYOUNGMI</h5>
                <div class="show-text">Paris 23 S/S</div>
          ...
          <div class="swiper-slide show-con">
            <ul class="show-in">
              ...
              <li class="show-desc">
                <h5>NIKE</h5>
                <div class="show-text">A FEEL FOR EVERY YOU</div>
               <!--  <button class="primary"><a href="javascript:void(0)">Shop now</a></button>  -->
              </li>
              <li class="pc-only show-pic2">
                <img src="https://www.casa.co.kr/show/sika/images/data08_obj03.jpg" alt="Ton" />
              </li>
            </ul>
          </div>
          <div class="swiper-slide show-con">
            <ul class="show-in">
              <li class="show-pic">
                <img src="<%=cp%>/imal/data/image_main/system.jpg" alt="Sika-design" />
              </li>
              <li class="show-desc">
                <h5>SYSTEM</h5>
                <div class="show-text">자유와 생동 그리고 <br/>시스템 파리 2023 S/S</div>
                 <!--  <button class="primary"><a href="javascript:void(0)">Shop now</a></button>  -->
              </li>
              <li class="pc-only show-pic2">
                <img src="https://www.casa.co.kr/show/ton/images/data08_obj04.jpg" alt="Sika-design" />
              </li>
            </ul>
          </div>
          <div class="swiper-slide show-con">
            <ul class="show-in">
              <li class="show-pic">
                <img src="<%=cp%>/imal/data/image_main/mue.jpg" alt="Carl hansen&Son" />
              </li>
              <li class="show-desc">
                <h5>MUE</h5>
                <div class="show-text"> 럭셔리한 하이엔드 브렌드와<br/>신진 레이블을 소개하는<br class="pc-only" />패션 멀티 스토어</div>
                <!--  <button class="primary"><a href="javascript:void(0)">Shop now</a></button>  -->
              </li>
              <li class="pc-only show-pic2">
  ...
  <article class="notice">
    <div>
      <h2>Notice</h2>
      <button class="primary"><a href="<%=cp%>/itmall/listnotice.do"/>more</a></button>
    </div>
    <ul class="notice-zone">
      <li>
        <span class="notice-icon">공지</span>
        <a href="<%=cp%>/itmall/articlenotice.do?pageNum=1&num=5">[IMAL스토어 1주년] 쇼핑지원금 이벤트 5주 차 당첨자 발표</a>
        <span class="notice-date pc-only">2023.01.23</span>
      </li>
      <li>
        <span class="notice-icon">공지</span>
        <a href="<%=cp%>/itmall/articlenotice.do?pageNum=1&num=4">[IMAL스토어 1주년] 쇼핑지원금 이벤트 4주 차 당첨자 발표</a>
        <span class="notice-date pc-only">2023.01.16</span>
      </li>
      <li>
        <span class="notice-icon">공지</span>
        <a href="<%=cp%>/itmall/articlenotice.do?pageNum=1&num=3">[IMAL스토어 1주년] 쇼핑지원금 이벤트 3주 차 당첨자 발표</a>
        <span class="notice-date pc-only">2023.01.09</span>
      </li>
      <li>
        <span class="notice-icon">공지</span>
        <a href="<%=cp%>/itmall/articlenotice.do?pageNum=1&num=2">[IMAL스토어 1주년] 쇼핑지원금 이벤트 2주 차 당첨자 발표</a>
        <span class="notice-date pc-only">2023.01.02</span>
      </li>
      <li>
        <span class="notice-icon">공지</span>
        <a href="<%=cp%>/itmall/articlenotice.do?pageNum=1&num=1">[IMAL스토어 1주년] 쇼핑지원금 이벤트 1주 차 당첨자 발표</a>
        <span class="notice-date pc-only">2022.12.25</span>
      </li>
    </ul>
  </article>
