      ...
      <div id="gnb">
        <div class="inner">
          ...
          <div>
            ...
            -->
            <div class="gnb-image" ><a href="javascript:void(0)"><img style="width: 300px;" src="<%=cp%>/imal/data/image_main/celine_1.jpg" alt="베르판" /></a></div>      
          </div>    
        </div>
      </div>
    </nav>
    ...
    <article class="product">
        ...
        <section>
            ...
            <div class="shippinginfo">
                <p>배송기간<span style="margin-right: 3px;">2일</span></p>
