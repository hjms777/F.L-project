  ...
  <script type="text/javascript">
	...
	function sendIt(){
		...
		*/
		...
		f.action = "<%=cp%>/itmall/createnotice_ok.do";
		f.submit();
...
<div id="bbs">
	...
	<input type="button" value=" 등록하기 " class="black-btn" onclick="sendIt();"/>
	<input type="reset" value=" 다시입력 " class="white-btn" 
	onclick="document.myForm.subject.focus();"/>
	<input type="button" value=" 작성취소 " class="white-btn" 
	onclick="javascript:location.href='<%=cp%>/itmall/listnotice.do';"/>
	</div>
