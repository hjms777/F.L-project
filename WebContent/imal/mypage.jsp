...
<script defer src="<%=cp%>/imal/data/main.js"></script>
  ...
  <link rel="stylesheet" href="<%=cp%>/imal/data/my.css" />
		        ...
		        <c:otherwise>
		        	...
		        	<!-- 로그아웃사진 -->
				       <li id="search-btn" style="margin-right: 15px;"> 
				        ...
				        <li>
				        	<a href="javascript:location.href='<%=cp%>/itmall/mybag.do'">
				        	<img src="<%=cp %>/imal/data/image_main/btn_top_order.png" alt="장바구니" />
							</a>
				        </li>
 ...
 <!-- 검색창 -->
    <form action="<%=cp %>/itmall/goodslist2.do" method="post" name="myForm">
...
<br/>
<div class="wrap">
  <br/><div class="greenContainer" style="background-color: #808080;">
  ...
  <div class="listContainer">
    ...
    <a href="<%=cp%>/itmall/updated.do" class="item">
        
        <div class="text" >회원정보수정</div>
        
    </a>
    <a href="javascript:location.href='<%=cp%>/itmall/myorders.do'" class="item">
